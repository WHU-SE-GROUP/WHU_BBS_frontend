<template>
  <div id="resource-content" :style="$store.state.collapsed ? 'margin: 0 10px;' : ''"
    ...
    <div>
      <div class="tag">
        <!-- Add mentor recommendation resource -->
        <a-badge class="info-box" @click="routerLink('https://whucsmentorguide.asia')" style="cursor: pointer"
                 :style="$store.state.collapsed ? 'width:100%;' : 'width:25%;border-right: 20px solid #f0f2f5;'">
          <div class="head-name">
            <a-avatar class="avatar" :size="35" src="https://img.icons8.com/color/48/000000/teacher.png"/>
            <div class="title">导师推荐</div>
          </div>
          <div class="meta-article">根据学生生需求推荐优秀导师</div>
        </a-badge>
        <!-- Existing resources -->
